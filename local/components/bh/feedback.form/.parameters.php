...
$arComponentParameters = array(
    ...
    "PARAMETERS" => array(
        ...
        "REQUIRED_SECTION" => array(
            "PARENT" => "DATA_SOURCE",
            "NAME" => GetMessage("F_FB_REQUIRED_SECTION"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "",
        ),
        "NAME_ELEMENT" => array(
        ...
        "CHECKBOX_TYPE" => array(
            ...
            "TYPE" => "LIST",
            "VALUES" => Array(
                'CHECKBOX' => GetMessage('CHECKBOX_TYPE_CHECK'),
                'TOGGLE' => GetMessage('CHECKBOX_TYPE_TOGGLE')
            ),
            "DEFAULT" => "CHECKBOX",
        ),
...
$arComponentParameters["PARAMETERS"]["SPEC_CHAR"] = array(
                "PARENT" => "SPAM",
                "NAME" => GetMessage("SPEC_CHAR"),
                "TYPE" => "CHECKBOX",
                "DEFAULT" => "N",
                "REFRESH" => "Y",
);
if($arCurrentValues["SPEC_CHAR"] == "Y")
{
        $arComponentParameters["PARAMETERS"]["SPEC_CHAR_LIST"] = array(
                "PARENT" => "SPAM",
                "NAME" => GetMessage("SPEC_CHAR_LIST"),
                "TYPE" => "STRING",
                "DEFAULT" => "@,/,<,>",
                "COLS" => 50,
        );
...
{
    $arProperty_LSID = array(
        "SELF" => GetMessage("F_LEAD_SELF"),
        "PARTNER" => GetMessage("F_LEAD_PARTNER"),
        "CALL" => GetMessage("F_LEAD_CALL"),
        "WEB" => GetMessage("F_LEAD_WEB"),
        "EMAIL" => GetMessage("F_LEAD_EMAIL"),
        "CONFERENCE" => GetMessage("F_LEAD_CONFERENCE"),
        "TRADE_SHOW" => GetMessage("F_LEAD_TRADE_SHOW"),
        "EMPLOYEE" => GetMessage("F_LEAD_EMPLOYEE"),
        "COMPANY" => GetMessage("F_LEAD_COMPANY"),
        "HR" => GetMessage("F_LEAD_HR"),
        "MAIL" => GetMessage("F_LEAD_MAIL"),
        "OTHER" => GetMessage("F_LEAD_OTHER"),
    );
    ...
    $arComponentParameters["PARAMETERS"]["LEAD_SOURCE_ID"] = array(
        "PARENT" => "LEAD",
        "NAME" => GetMessage("F_LEAD_ID_SOURCE"),
        "TYPE" => "LIST",
        "MULTIPLE" => "N",
        "VALUES" => $arProperty_LSID,
        "ADDITIONAL_VALUES" => "Y",
    );
}
