...
<div class="afbf alx_feed_back <? $arParams['INPUT_APPEARENCE'] != 'DEFAULT' ? strtolower($arParams['INPUT_APPEARENCE']) : '' ?>"
    ...
    <?
        ...
        <div class="alert alert-danger" style="background-color: #006700">
            Спасибо за Ваше мнение. Отзыв будет добавлен на сайт после модерации менеджером<br>
        </div>


        <script>

            $('.js_reviews__send-review').remove();
