...
<div id="AJAX_FILTER_CONTAINER">
    ...
    if (isset($_REQUEST['available_not']) && $_REQUEST['available_not'] == 'y') {
        $filter_catalog_prod['CATALOG_AVAILABLE'] = 'N';
    }

    if (isset($_REQUEST['available_yes']) && $_REQUEST['available_yes'] == 'y') {
        $filter_catalog_prod['CATALOG_AVAILABLE'] = 'Y';
    }

    if ((isset($_REQUEST['available_not']) && $_REQUEST['available_not'] == 'y') && (isset($_REQUEST['available_yes']) && $_REQUEST['available_yes'] == 'y')) {
        unset($filter_catalog_prod['CATALOG_AVAILABLE']);
    }


        $FILTER['PARAMS'] = $arParamsFilter;
        $FILTER['PARAMS']['FILTER_PROPERTY_AJAX'] = !empty($filter_catalog_prod) && isset($filter_catalog_prod)? $filter_catalog_prod : false;
        ?>
...
<? if ($arResult['DATA_SECTION']['DESCRIPTION'] && (!isset($_GET['PAGEN_1']) || intval($_GET['PAGEN_1']) < 2)): ?>
    <hr>
    <div class="promo">
        <div class="container">
