...
function offers($this) {
    ...
    //устоновление картинки
    console.log(DATA_OFFERS);
    $('.js_product__slider .swiper-wrapper .big_img_0 a').attr('href', this_offers['DETAIL_IMG']['src']);
    $('.js_product__slider .swiper-wrapper .big_img_0 a img').attr('src', this_offers['DETAIL_IMG']['src']);
    $('.product__slider-thumbs-wrap .smail_img_0 img').attr('src', this_offers['DETAIL_IMG']['src']);
    $('#form_prod_popup .popup-preorder__img img').attr('src', this_offers['DETAIL_IMG']['src']);
