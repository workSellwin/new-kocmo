...
$arResult['RES']['PANET_TEXT'] = [
    ...
    'product-using-method' => [
        ...
        'TEXT' => htmlspecialchars_decode($arResult['PROPERTIES']['SPOSOB_PRIMENENIYA']['VALUE']['TEXT'], ENT_HTML5),
    ],
    'product-composition' => [
        'ACTIVE' => $arResult['PROPERTIES']['SOSTAV']['VALUE'] ? 'Y' : 'N',
        'NAME' => 'состав',
        'TEXT' => htmlspecialchars_decode($arResult['PROPERTIES']['SOSTAV']['VALUE']['TEXT'], ENT_HTML5),
    ],
];
...
foreach ($arResult['OFFERS'] as &$value) {
    ...
    $value['OFFERS_IMG'] = $value['DETAIL_PICTURE']['ID'] ? CFile::ResizeImageGet($value['DETAIL_PICTURE']['ID'], array('width' => 33, 'height' => 33), BX_RESIZE_IMAGE_PROPORTIONAL, true) : NO_IMG_PATH;
    ...
    $arResult['dataOffers'][$value['ID']]['DETAIL_IMG'] = $value['DETAIL_PICTURE']['ID'] ?  CFile::ResizeImageGet($value['DETAIL_PICTURE']['ID'], array('width' => 545, 'height' => 360), BX_RESIZE_IMAGE_PROPORTIONAL, true) : ['src'=>NO_IMG_PATH] ;
...
if ($arResult['XML_ID'] and $arData = $ob->GetProductXml($arResult['XML_ID'])) {
    $arData = reset($arData);
