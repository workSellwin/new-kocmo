...
$OBJ_ITEMS['OBJ_ITEM'][$minPriceOffer['PRODUCT_ID']]['file_img'] =  !empty($file_img) ?  $file_img : ['src'=> NO_IMG_PATH_225] ;
...
$OBJ_ITEMS['OBJ_ITEM'][$minPriceOffer['PRODUCT_ID']]['PROP']['NAME'] = $arResult['ITEM']['NAME'];
$OBJ_ITEMS['OBJ_ITEM'][$minPriceOffer['PRODUCT_ID']]['PROP']['PREVIEW_TEXT'] = $arResult['ITEM']['PREVIEW_TEXT'];
