<div class="<?= $arResult['CLASS'] ?>">
    ...
    <div class="products-item__btns">
        <? if ($arResult['minPriceOffer']['PRICE_NEW'] && $arResult['ITEM']['CATALOG_QUANTITY'] > 0) { ?>
            <a href="#"
               id="<?= $arResult['ID'] ?>"
               onclick="productsItemAdd(<?= $arResult['minPriceOffer']['PRODUCT_ID'] ?>);return false;ga('send', 'event', 'v_korz2', 'btn_v_korz2'); yaCounter47438272.reachGoal('v_korz2'); return true;"
