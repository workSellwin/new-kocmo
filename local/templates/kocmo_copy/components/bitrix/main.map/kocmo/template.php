...
?>
<!--<a href="/catalog/" class="root-dir">Каталог</a>-->
    ...
    <tr>
        ...
        <td>
            <ul class="map-level-0">
                ...
                <li>
                    <a href="<?= $arItem["FULL_PATH"] ?>"><?= $arItem["NAME"] ?></a><? if ($arParams["SHOW_DESCRIPTION"] == "Y" && strlen($arItem["DESCRIPTION"]) > 0) { ?>
