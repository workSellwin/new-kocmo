...
<script>
    ...
    BX.addCustomEvent('onAjaxSuccess', function(){
        if(~arguments[1].data.indexOf('<?=$INPUT_ID?>')){
            $('#filter-category-1').jScrollPane();
        }

        // let bx_searche = document.querySelector('.bx_searche');
        //
        // if(!bx_searche){
        //     console.log('пусто');
        //
        // }
        //let category_1 = document.getElementById('filter-category-1');
        // if(category_1){
        //
        //     let jspPane = category_1.querySelector('.jspPane');
        //
        //     if(jspPane && !jspPane.children.length){
        //         console.log('category_1 пусто');
        //     }
        // }
