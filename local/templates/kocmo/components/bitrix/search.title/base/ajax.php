...
<div class="bx_searche">
    ...
    <? if (count($arResult["ELEMENTS"])): ?>
        ...
        <? foreach ($arResult["CATEGORIES"] as $category_id => $arCategory): ?>
            <div id="filter-category-<?= $category_id ?>">
                    ...
                    <? if ($category_id === "all"): ?>
                        <div class="bx_item_block all_result">
                            ...
                            <span class="all_result_title"><a
                                        href="<?= $arItem["URL"] ?>">ПОКАЗАТЬ ВСЕ РЕЗУЛЬТАТЫ ПОИСКА<? //= $arItem["NAME"] ?></a></span>
                            ...
                            <div class="bx_item_element">
                                ...
                                <div class="filter-elem-price-block">
                                    ...
                                    if (intval($oldPrice) > 0):?>
                                        <? $discountPercent = round((($oldPrice - $minPrice) / $oldPrice) * 100, 0); ?>
                                        <div class="bx_price">
